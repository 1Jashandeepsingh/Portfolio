        ...
        <div className="w-full lg:w-1/2">
          <div className=" flex justify-center lg:p-8">
            <motion.img
              ...
              " initial = {{x:100,opacity:0}} animate = {{x:0, opacity:1}} transition={{duration:1 , delay:1.5}} height={650} width={650}
            />
          </div>
        </div>
        <div className="w-full lg:w-1/2">
          <motion.div initial="hidden" animate="visible" variants={containerVariants} className="flex flex-col items-center lg:items-start mt-10">
            ...
            <motion.a variants={childVariants} href="/resume.pdf" target="_blank"
